  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        iconURL: 'https://cdn.discordapp.com/attachments/1147425299374559315/1151406046707990579/1029-sharkparty.gif', 
        url: 'https://discord.gg/FUEHs7RCqz'
    })
        .setDescription('> **Choose from below :**\n\n **Queue:** You wanna loop queue?\n **Current song:** Loop current song.\n **Close Loop:** End this mercy.')
        .setTimestamp()
